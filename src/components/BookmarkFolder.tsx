...
export default function BookmarkFolder({
  ...
  return (
    <button
      ...
      className="inline-flex justify-between w-full gap-2 px-4 py-3 text-white cursor-pointer hover:bg-slate-400/40"
    >
      <div className="flex gap-2 w-full">
        <Folder2 variant="Bulk" color="white" size={20} /> {bookmark.title}{" "}
        {bookmark.children &&
